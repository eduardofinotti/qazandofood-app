...
export default function Home({navigation}) {
  ...
  const renderItem = ({item}) => <Store item={item} />;
  ...
  useEffect(async () => {
    ...
    setTimeout(async function () {
      ...
      await axios
        .get(`http://${myIp}:9999/qazando-user`, {})
      ...
      await axios
        .get(`http://${myIp}:9999/qazando-store`, {})
        .then(function (response) {
  ...
  return (
    <View style={styles.content}>
      ...
      <ScrollView
        ...
        <Types
          logoType={require('../../assets/sorvetes.png')}
          name="Sorvetes"
        />
        <Types
          logoType={require('../../assets/saudavel.png')}
          name="Saudavel"
        />
        ...
        {isLoading && (
          <View style={styles.loadingContent}>
            <Image
              ...
              source={require('../../assets/pizza.gif')}
            />
